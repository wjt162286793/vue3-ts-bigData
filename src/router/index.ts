    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            redirect: "/dashboard/friend/shop/shopList",
            children: [
              {
                path: "/dashboard/friend/shop/shopList",
                name: "shopList",
                meta: {
                  cname: "梦商城列表",
                },
                component: () => import("@/views/friend/shop/list.vue"),
              },
              {
                path: "/dashboard/friend/shop/shopDetail",
                name: "shopDetail",
                meta: {
                  cname: "商品详情",
                },
                component: () => import("@/views/friend/shop/detailCom/index.vue"),
              },
            ],
          },
          {
